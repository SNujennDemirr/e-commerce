...
import { RootStackParamList } from './src/navigation/types'; // Parametreler için tanımlama

// Native Stack Navigator kullanıyoruz
const Stack = createNativeStackNavigator<RootStackParamList>(); // NativeStack kullanıyoruz
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator
        ...
        screenOptions={{ headerShown: false }} // Header'ları kendin yönetiyorsun
      >
